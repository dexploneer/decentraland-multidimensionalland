    ...
    public render():DCL.ISimplifiedNode {
       ...
       return (
         <entity id={this.props.data.key}>
           <plane position={{ x: 10, y: 0, z: 10 }} scale={{x: 19.99, y: 19.99, z: 1 }} rotation={{x: 90, y: 0, z: 0}} color="#ffffff"/>
           <gltf-model position={this.state.position} scale={this.state.scale} src={ "list/" + this.props.data.key + "/models/city/scene.gltf"}/>
         </entity>
       );
    }
 }
